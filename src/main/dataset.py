...
class Dataset(object):
    ...
    def get_train(self):
        ...
        dataset = self.create_dataset('train', self._parse,self._convert_and_scale) #self._random_jitter
    ...
    def get_demon(self):
        start = time()
        print('initialize val dataset...')
        demon_dataset = self.create_dataset_new('test', self._parse_new,self._convert_and_scale)#self._convert_and_scale
