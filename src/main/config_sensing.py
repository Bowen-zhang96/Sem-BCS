...
class Config(object):
    ...
    # LOG_DIR = os.path.join(ROOT_DATA_DIR, 'logs', datetime.now().strftime("%d%m%Y-%H%M%S")) lsp-lspet-mpii-smpl-3D-True1-sensing-140-deep-mpii3donly
    LOG_DIR = os.path.join(ROOT_PROJECT_DIR, 'logs', 'lsp-lspet-mpii-smpl-3D-True1-sensing-140-deep-mpii3donly')
