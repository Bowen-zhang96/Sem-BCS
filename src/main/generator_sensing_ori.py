...
class Sampling_plus_init_reconstruction_network(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.init_reconstruction_weight = np.random.randn(1, 1, 1, 103, 32*32*3)
        self.reconstruction_weight = tf.Variable(self.init_reconstruction_weight, dtype=tf.float32, name='reconstruction_weight', trainable=True)
