...
class Sampling_plus_init_reconstruction_network(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.sensing_importance = layers.Conv2D(50, 32, strides=[32, 32], use_bias=False, padding='valid',
                                                activation=None)
        ...
        self.conv7 = layers.Conv2D(250 * 250, 1, padding='same', activation=None)
    ...
    def call(self, inputs, **kwargs):
        ...
        weights_weight=tf.reshape(weights,[batch,height,width,250,250])
